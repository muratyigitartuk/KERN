...
def build_capability_registry(tools: dict[str, Tool]) -> CapabilityRegistry:
    descriptors = {
        ...
        "query_knowledge_graph": CapabilityDescriptor(
            name="query_knowledge_graph",
            title="Query Knowledge Graph",
            summary="Search entities and relationships in the local knowledge graph.",
            domain="documents",
            risk_level="low",
            confirmation_rule="never",
            side_effectful=False,
        ...
        "build_knowledge_graph": CapabilityDescriptor(
            name="build_knowledge_graph",
            title="Build Knowledge Graph",
            summary="Extract entities and relationships from all indexed documents to build the knowledge graph.",
            domain="documents",
            risk_level="low",
            confirmation_rule="never",
            side_effectful=True,
